...
const rulesCopy = {
  nl: {
    ...
    mainDeadlineSuffix: " (de eerste WK-wedstrijd). Elke wedstrijd sluit afzonderlijk 30 min vóór de aftrap — wat al gespeeld is, levert geen punten meer op.",
    ...
    faq: [
      ...
      { q: "Heb ik een wachtwoord nodig?", a: "Nee. Je logt in met een eenmalige link die we naar je e-mailadres sturen." },
      {
        ...
        a: "Je inschrijving loopt t/m donderdag 11 juni 21:00 (de eerste WK-wedstrijd). Belangrijk: elke groepswedstrijd sluit afzonderlijk 30 minuten vóór de aftrap — wat al begonnen of gespeeld is, kun je niet meer invullen en levert dus geen punten op. Vul je later in, dan mis je die wedstrijden. Wereldkampioen, finalisten, penaltyseries en 'hoe ver komt Oranje' blijf je aanpassen t/m 28 juni 21:00.",
      },
  ...
  en: {
    ...
    mainDeadlineSuffix: " (the first World Cup match). Each match closes individually 30 min before kick-off — anything already played no longer scores points.",
