...
export const metadata: Metadata = {
  title: "Voorwaarden",
  description: "De spelregels voor het gebruik van SlimeScore: gratis, eerlijk en voor de lol.",
};
  ...
  return (
    <main className="page-shell">
      ...
      <section className="grid gap-4 lg:grid-cols-2 lg:items-start">
        <article className="panel p-5">
          ...
          <ul className="mt-4 grid gap-2 text-sm font-semibold leading-7 text-[#48617f]">
            <li>SlimeScore is gratis voor deelnemers.</li>
        ...
        <article className="panel p-5">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-2xl font-black text-[#081634]">Deadlines en uitslagen</h2>
          </div>
          <ul className="mt-4 grid gap-2 text-sm font-semibold leading-7 text-[#48617f]">
            ...
            <li>De puntentelling staat uitgelegd op de <a className="font-black text-[#064ed6]" href="/regels">regelspagina</a>.</li>
          </ul>
        </article>
        ...
        <article className="panel p-5 lg:col-span-2">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-2xl font-black text-[#081634]">Poules en berichten</h2>
          </div>
          <ul className="mt-4 grid gap-2 text-sm font-semibold leading-7 text-[#48617f]">
            ...
            <li>
              Vragen? Mail <a className="font-black text-[#064ed6]" href={`mailto:${CONTACT_EMAIL}`}>{CONTACT_EMAIL}</a>.
            </li>
          </ul>
        </article>
      </section>
      ...
      <p className="mt-5 text-sm font-semibold text-[#48617f]">
        Lees ook ons <a className="font-black text-[#064ed6]" href="/privacy">privacybeleid</a>.
      </p>
