...
function KnockoutPanel({ matches, locale }: { matches: ScheduleMatch[]; locale: Locale }) {
  ...
  return (
    <div className="grid gap-3">
      <div className="schedule-section-tools schedule-section-tools-knockout">
        <div className="schedule-section-titlebar">
          <div>
            ...
            <p className="schedule-filter-help schedule-filter-help-inline">{scheduleCopy[locale].fixedInfo}</p>
          </div>
